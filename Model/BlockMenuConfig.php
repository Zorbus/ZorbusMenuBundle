...
class BlockMenuConfig extends BlockConfig
{

    public function __construct(AdminInterface $admin, FormFactory $formFactory, $httpKernel)
    {
        parent::__construct('zorbus_block.service.menu', 'Menu Block', $admin, $formFactory);
        $this->enabled = true;
    ...
    public function getFormMapper()
    {
        return $this->formMapper
                        ->add('menu', 'entity', array(
                            'class' => 'Zorbus\\MenuBundle\\Entity\\Menu',
    ...
    public function getBlockEntity(array $data, BlockEntity $block = null)
    {
        ...
        $block->setParameters(json_encode(array('menu_id' => $data['menu']->getId())));
